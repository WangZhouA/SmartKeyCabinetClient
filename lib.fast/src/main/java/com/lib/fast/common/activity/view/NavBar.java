...
public class NavBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initView(Context context, AttributeSet attrs, View rootView) {
        ...
        if (attrs != null) {
            ...
            int titleColor = typedArray.getColor(R.styleable.NavBar_titleColor, getResources().getColor(R.color.navbar_title_color));
            ...
            int rightTxtColor = typedArray.getColor(R.styleable.NavBar_rightTxtColor, getResources().getColor(R.color.navbar_title_color));
            ...
            mAutoSetStatusBarColor = typedArray.getBoolean(R.styleable.NavBar_autoSetStatusBarColor, false);
    ...
    public void setmAutoSetColor(boolean mAutoSetColor) {
        this.mAutoSetStatusBarColor = mAutoSetStatusBarColor;
    }
