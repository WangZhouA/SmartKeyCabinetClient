package com.lib.fast.common.http.cache.Catch;
...
public class CacheManager {
    ...
    private File getDiskCacheDir(Context context) {
        return FileUtils.getAppCacheDir(context, "OkhttpPost");
    }
