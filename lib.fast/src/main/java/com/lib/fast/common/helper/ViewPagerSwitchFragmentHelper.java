 ...
 */
public class ViewPagerSwitchFragmentHelper {

    private Object mFragmentObj;
    private ViewPager mViewPager;
    private OnSwitchFragmentListener mOnSwitchFragmentListener;

    public ViewPagerSwitchFragmentHelper(android.support.v4.app.Fragment fragment) {
        mFragmentObj = fragment;
        initViewPager(fragment.getView());
    }

    public ViewPagerSwitchFragmentHelper(Fragment fragment) {
        mFragmentObj = fragment;
        initViewPager(fragment.getView());
    }
