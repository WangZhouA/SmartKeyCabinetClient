...
//    }
    ...
    public static void autoAddStatusBarHeight(final Activity activity, final View view){
        if (activity == null || view == null) return;
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ViewGroup.LayoutParams params = view.getLayoutParams();
                if(view.getHeight() >= 0){
                    addStatusBarHeight(activity, view);
    ...
    public static void addStatusBarHeightMargin(Activity activity, View view) {
        if (activity == null || view == null) return;
        ViewGroup.LayoutParams params = view.getLayoutParams();
        XLog.d("StatusBarUtil addStatusBarHeightMargin height:%s", params.height);
    ...
    /**
     * 等待view绘制出来后添加statusbar高度的margin top
     */
    public static void autoAddStatusBarHeightMargin(final Activity activity, final View view){
        if(view == null || activity == null)return;
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                addStatusBarHeightMargin(activity, view);
                view.getViewTreeObserver().removeGlobalOnLayoutListener(this);
            }
        });
    }
